...
import yoot.nhom11.petcare.repository.specification.MedicalRecordSpecification;
...
public class MedicalRecordServiceImpl implements MedicalRecordService {
    ...
    public Page<MedicalRecordListResponse> getAllMedicalRecords(MedicalRecordFilterRequest filter, Pageable pageable) {
        return medicalRecordRepository.findAll(MedicalRecordSpecification.filterMedicalRecords(filter), pageable)
                .map(medicalRecordMapper::toMedicalRecordListResponse);
    }
